...
class ComponentToPrintNote extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          La Direction Commerciale & Exploitation
        </h5> */}
        <br />
        ...
        >
          <p>
            <strong>Montant Net à Payer</strong> : {total}
          </p>
          <p>
...
export default ComponentToPrintNote;
