  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <span style={{ fontWeight: 'bold' }}>FERI No : </span>
          {feri}
        </div>
        <div
          className="print-source"
        ...
        <div>
          ...
          >
            <strong>ANTWERP</strong> : {date}
          </p>
          <p className="print-source" style={{ textAlign: 'left', margin: '1rem 1rem 0rem 1rem' }}>
            <strong>
              RECEIVED by the Carrier from the Shipper in apparent good order and condition "unless
              otherwise noted herein" the total number or quantity of Containers or packages or
              units indicated *. stated by the Shipper to comprise the Goods specified above, for
              Carriage subject to all the terms hereof "INCLUDING THE TERMS ON THE REVERSE HEREOF
              AND THE TERMS OF THE CARRIERS APPLICABLE TARIF" from the Place of Receip or the Port
              of Loading. whichever is applicable, In accepting this Bill of Lading the Merchant
              expressly accepts and agrees to all its terms, conditions and exceptions, whether
              printed, stamped or written, or otherwise incorporated, notwithstanding the
              non-signing of this Bill of Lading by the Merchant.
            </strong>{' '}
            : <span>{}</span>
          </p>
        </div>
